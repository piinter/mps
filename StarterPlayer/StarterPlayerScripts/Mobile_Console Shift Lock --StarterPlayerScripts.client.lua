...
if (IsMobile and MOBILE_ENABLED) or (IsConsole and CONSOLE_ENABLED) then
	...
	local middleGui = Instance.new('ScreenGui')
	middleGui.Name = "ShiftLockGui"
	middleGui.ResetOnSpawn = false
	middleGui.Parent = Player.PlayerGui
	...
	RunService:BindToRenderStep("ShiftLockGui",Enum.RenderPriority.Camera.Value+1,OnStep)
end