...
--[[ Constants ]]--
-- "http://www.roblox.com/asset/?id=12658369042" default
local DEFAULT_MOUSE_LOCK_CURSOR = "http://www.roblox.com/asset/?id=3740298602"
...
function MouseLockController:GetMouseLockOffset()
	...
	if offsetValueObj and offsetValueObj:IsA("Vector3Value") then
		...
		offsetValueObj.Value = game.Players.LocalPlayer.Data.Misc.ShiftLock.Value -- Legacy Default Value
	...
	return game.Players.LocalPlayer.Data.Misc.ShiftLock.Value
end
