local function GetColorFromStringValue(text)
	text:gsub(" ", "")
	local r, g, b = table.unpack(string.split(text, ","))
...
local SLOT_EQUIP_COLOR = Color3.new(0, 0.333333, 1)
local SLOT_EQUIP_THICKNESS = 0.05 -- Relative
...
local function MakeSlot(parent, index)
	...
	local function UpdateSlotFading()
		...
		SlotFrame.BackgroundColor3 = (SlotFrame.Draggable) and SLOT_DRAGGABLE_COLOR or GetColorFromStringValue(game.Players.LocalPlayer.Data.Misc.BackpackBackgroundColor.Value)
	end
		...
		if not unequippedOverride and IsEquipped(self.Tool) then -- Equipped
			...
			if not HighlightFrame then
				...
				for _, data in pairs(dataTable) do
					...
					edgeFrame.BackgroundColor3 = GetColorFromStringValue(game.Players.LocalPlayer.Data.Misc.BackpackBorderColor.Value)
					game.Players.LocalPlayer.Data.Misc.BackpackBorderColor.Changed:Connect(function()
						edgeFrame.BackgroundColor3 = GetColorFromStringValue(game.Players.LocalPlayer.Data.Misc.BackpackBorderColor.Value)
					end)
	...
	SlotFrame.BackgroundColor3 = GetColorFromStringValue(game.Players.LocalPlayer.Data.Misc.BackpackBackgroundColor.Value)
	game.Players.LocalPlayer.Data.Misc.BackpackBackgroundColor.Changed:Connect(function()
		SlotFrame.BackgroundColor3 = GetColorFromStringValue(game.Players.LocalPlayer.Data.Misc.BackpackBackgroundColor.Value)
	end)
...
InventoryFrame.BackgroundColor3 = GetColorFromStringValue(game.Players.LocalPlayer.Data.Misc.BackpackBackgroundColor.Value)
game.Players.LocalPlayer.Data.Misc.BackpackBackgroundColor.Changed:Connect(function()
	InventoryFrame.BackgroundColor3 = GetColorFromStringValue(game.Players.LocalPlayer.Data.Misc.BackpackBackgroundColor.Value)
end)
...
do -- Search stuff
	...
	searchFrame.BackgroundColor3 = GetColorFromStringValue(game.Players.LocalPlayer.Data.Misc.BackpackBackgroundColor.Value)
	game.Players.LocalPlayer.Data.Misc.BackpackBackgroundColor.Changed:Connect(function()
		searchFrame.BackgroundColor3 = GetColorFromStringValue(game.Players.LocalPlayer.Data.Misc.BackpackBackgroundColor.Value)
	end)
	...
	xButton.BackgroundColor3 = GetColorFromStringValue(game.Players.LocalPlayer.Data.Misc.BackpackBackgroundColor.Value)
	game.Players.LocalPlayer.Data.Misc.BackpackBackgroundColor.Changed:Connect(function()
		xButton.BackgroundColor3 = GetColorFromStringValue(game.Players.LocalPlayer.Data.Misc.BackpackBackgroundColor.Value)
	end)
