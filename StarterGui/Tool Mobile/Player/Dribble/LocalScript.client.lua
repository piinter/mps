...
function leftClick(mouse)
	if 	script.Parent.Parent.DribbleUI.Visible == false then
		script.Parent.Parent.DribbleUI.Visible = true
	...
	elseif 	script.Parent.Parent.DribbleUI.Visible == true then
