...
Tool.MouseButton1Click:connect(function()
	...
	TM.EditWeld("Right Leg", CFrame.new(0.8,-1.5,1) *  CFrame.fromEulerAnglesXYZ(math.pi/-12,-1,0.5))
	TM.EditWeld("Left Leg", CFrame.new(-0.8,-1.5,-0.7) *  CFrame.fromEulerAnglesXYZ(math.pi/2.5,0.8,-0.8))
	Kick = true
	wait(0.2)
	TM.ResetWelds()
	Kick = false
