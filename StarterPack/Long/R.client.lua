...
Mouse.KeyDown:connect(function(key)
	...
	wait(0.15)
		TM.EditWeld("Right Leg", CFrame.new(0.5,-1.5,-0.8) *  CFrame.fromEulerAnglesXYZ(math.pi/3.5,0,0))
	else
		TM.EditWeld("Left Leg", CFrame.new(-0.5,-1.5,1) *  CFrame.fromEulerAnglesXYZ(-0.785,0.5,0))
	wait(0.3)
	TM.EditWeld("Left Leg", CFrame.new(-0.5,-1.5,-0.8) *  CFrame.fromEulerAnglesXYZ(math.pi/3.5,0,0))
	end
	Kick = true
	wait(0.25)
	TM.ResetWelds()
