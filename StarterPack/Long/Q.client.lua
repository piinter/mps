...
Mouse.KeyDown:connect(function(key)
	...
	wait(0.15)
	TM.EditWeld("Right Leg", CFrame.new(-0.2,-1.8,-0.1) *  CFrame.fromEulerAnglesXYZ(math.pi/9,0,-0.7))
		TM.EditWeld("Left Leg", CFrame.new(-0.4,-2,-0.5) *  CFrame.fromEulerAnglesXYZ(math.pi/9,0,0.1))
	else
		TM.EditWeld("Left Leg", CFrame.new(-0.5,-1.5,1) *  CFrame.fromEulerAnglesXYZ(-math.pi/4,-0.5,0))
	wait(0.15)
	TM.EditWeld("Left Leg", CFrame.new(0.2,-1.8,-0.1) *  CFrame.fromEulerAnglesXYZ(math.pi/9,0,0.7))
	TM.EditWeld("Right Leg", CFrame.new(0.4,-2,-0.5) *  CFrame.fromEulerAnglesXYZ(math.pi/9,0,-0.1))
	end
	Kick = true
	wait(0.2)
	TM.ResetWelds()
...
Player.Character["Right Leg"].Touched:connect(function(hit)
	...
	local angle = Vector3.new(4e+006,5e+004,4e+006)
	Kick = false
