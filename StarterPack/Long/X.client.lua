...
Mouse.KeyDown:connect(function(key)
	...
	wait(0.15)
		TM.EditWeld("Right Leg", CFrame.new(-0.2,-1.8,-0.1) *  CFrame.fromEulerAnglesXYZ(math.pi/4.5,0,-0.7))
	...
	wait(0.15)
		TM.EditWeld("Left Leg", CFrame.new(0.2,-1.8,-0.1) *  CFrame.fromEulerAnglesXYZ(math.pi/4.5,0,0.7))
