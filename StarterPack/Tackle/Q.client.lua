...
Mouse.KeyDown:connect(function(key)
	...
	TM.EditWeld("Left Leg", CFrame.new(-0.8,-1.3,-1.5) *  CFrame.fromEulerAnglesXYZ(math.pi/2.5,0.3,-0.2))
	TM.EditWeld("Right Leg", CFrame.new(0.8,-1.8,0.8) *  CFrame.fromEulerAnglesXYZ(-math.pi/5,-0.5,0.3))
	wait(0.05)
	TM.EditWeld("Left Leg", CFrame.new(-0.8,-1.5,-1.3) *  CFrame.fromEulerAnglesXYZ(math.pi/3,0.5,-0.2))
	wait(0.05)
	TM.EditWeld("Right Leg", CFrame.new(0.9,-1.8,1) *  CFrame.fromEulerAnglesXYZ(-math.pi/4,-0.5,0.3))
	Kick = true
	wait(0.25)
	TM.ResetWelds()
	Kick = false
...
Player.Character["Left Leg"].Touched:connect(function(hit)
	...
	local force = Player.Character["Left Leg"].CFrame.lookVector * 50
