...
Mouse.KeyDown:connect(function(key)
	...
	Player.Character["HumanoidRootPart"].CFrame = Player.Character["HumanoidRootPart"].CFrame + Vector3.new(0,0.5,0)
...
Player.Character["Right Leg"].Touched:connect(function(hit)
	...
	local force = Player.Character.Torso.CFrame.UpVector * 90
...
Player.Character["Left Leg"].Touched:connect(function(hit)
	...
	if hit.Name ~= "TPS" then return end
	if Kick == false then return end
	local force = (Player.Character.Torso.CFrame.UpVector * 90) + (Player.Character.Torso.CFrame.lookVector * -20)
	local angle = Vector3.new(4e+006,2e+003,4e+006)
	Kick = false
