...
Mouse.KeyDown:connect(function(key)
	...
	TM.EditWeld("Right Leg", CFrame.new(0.5, -1.8, -0.8) * CFrame.fromEulerAnglesXYZ(math.pi / 6, 0, 0))
	wait(0.1)
	TM.EditWeld("Right Leg", CFrame.new(0.9, -1.8, -0.6) * CFrame.fromEulerAnglesXYZ(math.pi / 7, -0.2, 0.3))
	wait(0.1)
	TM.EditWeld("Right Leg", CFrame.new(1.1, -1.8, -0.3) *  CFrame.fromEulerAnglesXYZ(math.pi / 10, -0.3, 0.5))
	wait(0.05)
	TM.EditWeld("Left Leg", CFrame.new(-0.7, -1.8, -0.7) * CFrame.fromEulerAnglesXYZ(math.pi / 6, 0.5, -0.2))
	TM.EditWeld("Right Leg", CFrame.new(0.7, -1.8, 0.5) *  CFrame.fromEulerAnglesXYZ(-math.pi / 6, math.pi/2,0))
	Kick = true
	wait(0.2)
	TM.ResetWelds()
	Kick = false
...
Player.Character["Left Leg"].Touched:connect(function(hit)
	...
	local force = Player.Character["Left Leg"].CFrame.lookVector * 22
...
Player.Character["Right Leg"].Touched:connect(function(hit)
	...
	if hit.Name ~= "TPS" then return end
	if Kick == false then return end
	local force = Player.Character["Right Leg"].CFrame.lookVector * 24
